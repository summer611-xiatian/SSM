...
<head>
    ...
    <script type="application/javascript">
        $(function () {
            $.getJSON("/getLoginLog",function (result) {
                $.each(result,function (i,item) {
               var timeString=item.createtime;
                   var  time=timeString.substr(0,timeString.length-2);
                    $("#tt").append("<tr><td>"+item.no+"</td><td>"+item.ip+"</td><td>"+item.location+"</td><td>"+time+"</td></tr>")
                })
            })
        })
    </script>
