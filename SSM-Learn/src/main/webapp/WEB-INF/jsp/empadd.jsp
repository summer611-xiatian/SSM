...
<head>
    ...
    <script>
        function addEmp() {
            $.post("/addEmp",$("#ss").serialize(),function (result) {
...
<div class="layui-container" style="margin-top: 5px">
    <form class="layui-form" action="#" method="post" id="ss" >
        ...
        <div class="layui-form-item">
            <input class="layui-btn"  style="margin-left: 10%"  id="btn1" disabled="disabled" type="button" onclick="addEmp()" value="确认新增">
        </div>
    </form>
</div>
...
<script>
    ...
    //初始化数据
    function initData() {
        $.getJSON("/findDeparts",null,function(arr){
